...
def accOSS(accDict):
    ...
    for doc in ossCur:
        ...
        if version[1]=='2' or version[2]=='T' or version[0] == 'E':
            version = version[0:2]
        else:
            version =version[0:3]
...
def onlineACC():
    ...
    g1sratio,g1sactive,g1stotal,g1pratio,g1pactive,g1ptotal,g1ratio,g1active,g1total,e1ratio,e1active,e1total)
    ...
    (recorddate,resultlist[0],resultlist[1],resultlist[2],ratioDict.get('G2',0),len(accDict.get('G2',list())),typeDict.get('G2',0),
     ...
     ratioDict.get('E1',0),len(accDict.get('E1',list())),typeDict.get('E1',0)))
    remoteCon.commit()
    remoteCon.close()
